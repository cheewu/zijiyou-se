...
public class AttractionPosterTest extends TestCase {
	
	AttractionPoster myServer;
	MongoConfig config;
	String url;
	...
	protected void setUp() throws Exception {
		url = "http://106.187.38.163:8080/server/att/";
		url = "http://192.168.0.197:8080/server/att/";
		config = new MongoConfig("192.168.0.184", 27017, "fragment", "");
		myServer = new AttractionPoster(url, null, config);
