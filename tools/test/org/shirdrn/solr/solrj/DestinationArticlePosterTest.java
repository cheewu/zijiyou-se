...
public class DestinationArticlePosterTest extends TestCase {
	
	DestinationArticlePoster myServer;
	MongoConfig config;
	String url;
	...
	protected void setUp() throws Exception {
		...
		config = new MongoConfig("192.168.0.184", 27017, "page", "Article");
		myServer = new DestinationArticlePoster(url, null, config);
	...
	public void testPostUpdate() {
		...
		myServer.setMaxIndexDocCount(500000);
