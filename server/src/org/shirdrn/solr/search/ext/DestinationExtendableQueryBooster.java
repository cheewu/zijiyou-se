 ...
 * @date   2011-12-27
 */
public class DestinationExtendableQueryBooster {

	private static final Logger LOG = LoggerFactory.getLogger(DestinationExtendableQueryBooster.class);
	...
	public DestinationExtendableQueryBooster(Map conditions) {
		super();
		...
		maxWordCount = (Integer) conditions.get(ConfigParams.EXT_MAX_WORD_COUNT);
