...
public abstract class AbstractSearchServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -916544597666249144L;
	final Logger LOG = LoggerFactory.getLogger(AbstractSearchServlet.class);
	...
	public abstract void interceptHttpActions(HttpServletRequest request,
